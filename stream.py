...
def get_youtube_stream(url: str = "https://www.youtube.com/watch?v=dQw4w9WgXcQ"):
    """ Create videostream from youtube video url """
    video = pafy.new(url)
    best  = video.getbest()
...
class SensorFactory(GstRtspServer.RTSPMediaFactory):
    def __init__(self, **properties):
        ...
        self.cap = cv2.VideoCapture(get_youtube_stream(opt.video_url))
